...
(def-doom-theme doom-shades-of-purple
  ...
  ((bg         '("#2d2b55" "#2d2b55"  "black"))
   ...
   (region     '("#ef238f" "#ef238f" "brightblack"))
   ...
   (magenta       '("#FF0090" "#FF0090" "brightmagenta"))
   (violet        '("#ff89d3" "#f989d3" "magenta"))
   (light-pink    '("#ff44bf" "#ff44bf" "magenta"))
   (pink          '("#ff628c" "#ff628c" "magenta"))
   (cyan          '("#00f2fc" "#00f2fc" "brightcyan"))
   (dark-cyan     '("#007272" "#007272" "cyan"))
   (purple        '("#9d36ff" "#9d36ff" "magenta"))
